        ...
        switch (options) {
            ...
            case "enable":
                return this.each(function() {
                    ...
                    if (e) {
                        var i = new Candlestick(e, n);
                        i.parent = e, i.handle = e.find(".candlestick-toggle"), i.element = t("#" + t(this).attr("id")), i.parent.removeClass("candlestick-disabled")
                    }
                });
            case "disable":
                return this.each(function() {
                    ...
                    if (e) {
                        var i = new Candlestick(e, n);
                        i.parent = e, i.handle = e.find(".candlestick-toggle"), i.element = t("#" + t(this).attr("id")), i.parent.addClass("candlestick-disabled")
                    }
                })
        }
