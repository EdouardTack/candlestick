...
Candlestick.prototype.wrapElement = function () {
    ...
    this.element.wrap('<div class="candlestick-wrapper candlestick-size-' + this.settings.size + '"><div data-candlestick-id="' + $id + '" class="candlestick-bg' + $classes + '"><div class="candlestick-toggle"></div><div class="candlestick-off"><i class="fa fa-times"></i></div><div class="candlestick-nc">&nbsp;</div><div class="candlestick-on"><i class="fa fa-check"></i></div><input type="hidden" value="' + this.default.value + '" name="' + this.default.name + '" id="' + $id + '"' + datas + $inputDisabled + $inputReadonly + '></div></div>');
}
